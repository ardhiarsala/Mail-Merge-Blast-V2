...
muteHttpExceptions:true,
  ...
  if(row[2].length >= 1){
    //If statement on whether there are attachment values. Converts GDrive files (Docs and PDFs only) into blob attachments if valid ID values exists, otherwise no attachments are included.
